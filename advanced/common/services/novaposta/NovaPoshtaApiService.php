...
final class NovaPoshtaApiService
{
     ...
     */
    private const WAREHOUSE_TYPE_POST_OFFICE_REF =
    ...
    public function __construct(
        private readonly NovaPoshtaApiClient $apiClient,
    )
    {
    }
    ...
    {
        if ($page === null) {
            return self::DEFAULT_WAREHOUSE_PAGE;
        }
    ...
    /**
     * Диагностический метод для получения справочника типов точек.
     *
     * В основном checkout-процессе не используется.
     *
     * @return array<string, mixed>
     */
